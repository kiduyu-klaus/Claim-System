...
<body id="home">
	...
	<div class="section-out">
		<section class="login-section">
			<div class="login">
				<form id="form_login" name="form_login" action="index.php" method="post">
					<ul class="ul-list">
		...
		<section class="signup-section">
			<div class="login">
				<form id="form_signup" name="form_signup" action="signup.php" method="post">
					<ul class="ul-list">
						<li><input type="text" required pattern="^[a-zA-Z ]+$" class="input" id="reg_name" name="reg_name" maxlength="32" placeholder="Claimer's Name"/><span class="icon"><i class="material-icons">account_box</i></span></li>
	...
	<header>
		...
		<a href="#home">
			<div class="navbar-logo">
				<img src="https://claimit.eu/assets/images/logo-footer.png"/>
	...
	<div class="welcome wrap-width">
		...
		<div class="welcome-text">
			<p id="text-heading">MEDICAL CLAIMS System</p>
			<p id="text-context">Dedan Kimathi University (DeKUT) has a strength of at least 1000 working staff,<br> and all of them are provided with medical reimbursement facility. <br>Hence the expenditure incurred  for treatment is reimbursed by the institution. <br>For reimbursement, one has to fill a form detailing the treatment <br>undertaken which includes the name and cost of medicines, <br>laboratory tests, and surgery.</p>
	...
	<div class="link-container clearfix">
		<div class="wrap-width">
			<a id="register" href="#register">Sign Up Now</a>
			<p id="join">Join the System - Be a part of the reimbursed community.</p>
		</div> 
	</div>	 <!-- link-container -->
	...
	<div class="about-container clearfix wrap-width" id="about">
		...
		<p>We are a group of highly motivated students and we are trying to solve the daily life problems of Delays and manual systems which hinders Claimers to be successfully reimbursed.  </p>
		</div>	<!-- col_one_third -->
		<div class="col_one_third col_2nd">
		<h1>OUR <span>MISSION</span>.</h1>
		<div class="bottom-border"></div>	<!-- border-bottom -->
		
		<p>To have a Complete end to end solution to cover all aspects of online claim and reimbursement system.</p>
		</div>	<!-- col_one_third -->
		<div class="col_one_third col_3rd">
		<h1>WHAT WE <span>PROVIDE</span>.</h1>
		<div class="bottom-border"></div> <!-- border-bottm -->	
		<p>A platform where Claimers can fill the form online and submit the necessary document for claim processing department through online. This website will permit to enter new claim, track the claim status and maintaining master information. They are the main users of this system and management can approve or reject the claim requests sent by the staff</p>
		...
		<div id="form-main">
    		...
    		<div class="contact-div contact-detail">
    			...
    			<div class="detail-container" id="phone-no">
    				...
    				<p class="contact-context" id="phone-text">(+254)770-886-239</p>
    			</div>
    			<div class="detail-container" id="email-id">
    				<i class="material-icons second">email</i>
	    			<p class="contact-context" id="mail-text">klaus@claimers.co.ke</p>
	    		</div>
	...
	<footer>
		...
		<div id="copyrights">
				<span class="siteName">Claimers System ©  2019. All rights reserved.</span>
            </div><!--copyrights-->
	</footer>
